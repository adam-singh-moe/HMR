 ...
 */
export const TAPS_METRIC_WEIGHTS = {
  STAR_3: 10, // ***
  STAR_2: 9, // **
  STAR_1: 6, // *
} as const;
...
export const TAPS_RATING_THRESHOLDS = {
  ...
  C: {
    ...
    label: "Standard",
    grade: "C",
    description: "Meeting basic expectations with room for growth",
  },
  D: {
    min: 86,
    max: 214,
    label: "Struggling",
    grade: "D",
    description: "Below expectations, requires focused improvement",
  },
  E: {
    min: 0,
    max: 85,
...
export type TAPSCategoryName =
  (typeof TAPS_CATEGORY_NAMES)[keyof typeof TAPS_CATEGORY_NAMES];
...
export interface TAPSLeadershipScores {
  ...
  quarterlyProjectionPlan?: string;
...
export interface TAPSAcademicsScores {
  ...
  sbaCompletion?: number; // 0-100 percentage
...
export interface TAPSSchoolCultureScores {
  ...
  remediationLevel:
    | "all_grades_4plus_hrs"
    | "50_99_grades_4plus_hrs"
    | "all_grades_2_3_hrs"
    | "some_grades_2_3_hrs"
    | "less_than_2_hrs";
