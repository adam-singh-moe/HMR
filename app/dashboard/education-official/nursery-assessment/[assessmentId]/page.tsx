...
export default function EducationOfficialNurseryAssessmentDetailPage() {
  return (
    <AuthWrapper requiredRole="Education Official">
      <NurseryAssessmentDetailContent />
    </AuthWrapper>
  )
}

function NurseryAssessmentDetailContent() {
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <Card className="flex flex-col shadow-sm bg-white dark:bg-[hsl(222,47%,9%)] border-slate-200/80 dark:border-slate-700/50 rounded-xl overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-6">
            <div className="flex items-center gap-3 md:gap-4 min-w-0 flex-1">
              <Button
                ...
                size="sm"
                onClick={handleBack}
                className="flex items-center gap-2 flex-shrink-0 min-h-[44px] min-w-[44px]"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-2 md:gap-3 flex-shrink-0">
              ...
              <Select value={format(new Date(assessment.created_at), 'MMMM yyyy')}>
                <SelectTrigger className="w-full sm:w-48 md:w-56 lg:w-64 min-h-[44px]">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
        ...
        <CardContent className="flex-1 flex overflow-hidden p-0 relative min-h-[500px]">
              ...
              <div className="space-y-0.5 p-2">
                {sections.map((section) => {
                  ...
                  return (
                    <button
                      key={section.id}
                      className={`w-full flex items-center gap-2 px-2.5 py-2 rounded-lg transition-all duration-200 text-left min-h-[36px] ${
                        isActive
                    ...
                    >
                      <Icon className={`h-4 w-4 flex-shrink-0 ${isActive ? 'text-white' : 'text-slate-400 dark:text-slate-500'}`} />
          ...
          <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-white dark:bg-[hsl(222,47%,9%)]">
            ...
            <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 lg:p-6 scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-700 scrollbar-track-transparent bg-white dark:bg-[hsl(222,47%,9%)]">
