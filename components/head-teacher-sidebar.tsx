  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-5 border-b border-slate-200/80 dark:border-slate-700/50">
        <Link href="/dashboard/head-teacher" className="flex items-center gap-3">
      ...
      <div className="p-3 border-t border-slate-200/80 dark:border-slate-700/50">
        <button
          ...
          className={`w-full p-4 rounded-xl text-white shadow-lg cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-[1.02] ${
            isLoadingReadiness
        ...
        >
          ...
          {isLoadingReadiness ? (
            ...
            <>
              ...
              <p className="text-xs text-white/70 mt-1">Click to update status</p>
            </>
          )}
        </button>
      </div>
